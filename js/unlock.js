const unlock = (() => {
    const products = [
        {
            img: 'url(./assets/images/products/unlock1.jpg)',
            name: 'Mở mạng, Unlock iPhone 11 Pro | Max',
            price: 'Liên hệ',
            link: '#',
        },
        {
            img: 'url(./assets/images/products/unlock2.jpg)',
            name: 'Mở mạng, Unlock Samsung Galaxy S10e | S10 Plus | Lite',
            price: 'Liên hệ',
            link: '#',
        },
        {
            img: 'url(./assets/images/products/unlock3.jpg)',
            name: 'Bẻ / Mở khóa iCloud iPhone X, XS, XS Max, Xr',
            price: '68.000.000đ',
            link: '#',
        },
        {
            img: 'url(./assets/images/products/unlock4.jpg)',

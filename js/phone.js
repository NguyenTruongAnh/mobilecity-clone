const phones = (() => {
    const products = [
        {
            img: 'url(./assets/images/products/phone1.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone2.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone3.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone4.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone5.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone6.jpg)',
        ...
        {
            img: 'url(./assets/images/products/phone7.jpg)',
